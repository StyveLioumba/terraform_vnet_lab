...
# Module resource_groups is used to build Resources Groups [Primary and Secondary] in Azure
...
module "vm" {
  ...
  final_windowsVM_pswd                 = var.final_windowsVM_pswd
  final_linuxVM_pswd                   = var.final_linuxVM_pswd
  depends_on                           = [module.virtual_networks, time_sleep.wait_10_seconds]
}
